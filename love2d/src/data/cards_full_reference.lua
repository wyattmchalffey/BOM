...
return {
  ...
  },
  {
    ...
    attack = 1,
    health = 4,
    text = "Action — Rest: Place 2 Knowledge Counters on any target(s). Action — 2 Gold, Rest: Search deck for any Science Spell or Human Technology and add to Hand.",
    costs = {},
    upkeep = {},
    subtypes = { "Scholar", "Royal" },
    abilities = {
      {
        type = "activated",
        cost = {},
      ...
      },
      {
        ...
        cost = { { type = "gold", amount = 2 } },
        effect = "tutor",
        effect_args = { filter = { subtypes = {"Science", "Technology"} } },
      },
    },
  },
